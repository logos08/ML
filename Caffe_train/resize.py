...
nameList = sorted(os.listdir("data/{}_fsize_xml".format(part)))
...
for name in nameList:
    ...
    img_fsize_path = "data/{}_fsize_img/{}.jpg".format(part, name)
    xml_fsize_path = "data/{}_fsize_xml/{}.xml".format(part, name)

    img_rsize_path = "data/{}_rsize_img/{}.png".format(part, name)
